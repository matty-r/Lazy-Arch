...
officePackages=(cups cups-pdf system-config-printer tesseract tesseract-data-eng pdftk libreoffice-fresh hunspell libmythes mythes-en okular masterpdfeditor-free gscan2pdf otf-ibm-plex ttf-carlito ttf-caladea ttf-liberation)
...
qemuGuestPackages=(qemu-guest-agent spice-vdagent xf86-video-qxl-git)
...
kdePackages=(noto-fonts-emoji plasma-meta kcalc konsole spectacle dolphin dolphin-plugins filelight kate kwalletmanager kdeconnect kdf kdialog kfind packagekit-qt5 ffmpegthumbs ark gwenview print-manager sddm partitionmanager firefox bluedevil)
